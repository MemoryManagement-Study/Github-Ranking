...
class ProcessorREST(object):
    ...
    def __init__(self):
        ...
        self.api_repo_stars = r'https://api.github.com/search/repositories?q=stars:>0&sort=stars&per_page=200'
        self.api_repo_forks = r'https://api.github.com/search/repositories?q=forks:>0&sort=forks&per_page=200'
        self.api_repo_stars_lang = r'https://api.github.com/search/repositories?q=language:{lang}&stars:>0&sort=stars&per_page=200'
...
class ProcessorGQL(object):
    ...
    def __init__(self):
        ...
        """
        self.gql_stars = self.gql_format % "language:C sort:stars"
        self.gql_forks = self.gql_format % "language:C sort:forks"
